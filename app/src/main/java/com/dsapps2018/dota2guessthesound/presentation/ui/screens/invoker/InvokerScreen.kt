...
fun InvokerScreen(
    ...
    val time by invokerViewModel.gameTimer.collectAsStateWithLifecycle()
    ...
    Scaffold(contentWindowInsets = WindowInsets(0.dp, 0.dp, 0.dp, 0.dp), content = { padding ->

        if (showConnectionDialog) SingleOptionDialog(onDismiss = {
        ...
        Box(
            modifier
                ...
                .paint(
                    painterResource(id = R.drawable.invoker_bg), contentScale = ContentScale.Crop
                ),
            ...
            Column(
                ...
                Row(
                    ...
                    Image(painterResource(R.drawable.ic_invoke),
                        contentDescription = "",
                        contentScale = ContentScale.Crop,
                        modifier = Modifier
                            .size(80.dp)
